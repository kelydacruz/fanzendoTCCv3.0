...
test('define perfis institucionais e limita outros domínios ao colaborador externo', () => {
    ...
    assert.equal(perfilPeloEmail('docente@ifsul.edu.br.site-falso.com'), 'colaborador');
    assert.equal(perfilPeloEmail('pessoa@gmail.com'), 'colaborador');
});
...
test('reconhece somente o e-mail administrativo configurado', () => {
    ...
    assert.equal(perfilPeloEmail('outra-conta@gmail.com'), 'colaborador');
